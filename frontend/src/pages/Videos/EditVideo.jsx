...
function EditVideo() {
  ...
  useEffect(() => {
    const loadData = async () => {
      try {
        ...
        setFormData({
          client:
            typeof video.client === "object"
              ? video.client?._id || ""
              : video.client || "",

          order:
            typeof video.order === "object"
              ? video.order?._id || ""
              : video.order || "",
          ...
          assignedEditor:
            typeof video.assignedEditor === "object"
              ? video.assignedEditor?._id || ""
  ...
  const filteredScripts = scripts.filter((script) => {
    if (!formData.client || !formData.order) {
      return false;
    }
  ...
  return (
    <div className="videos-page">
      ...
      <div className="videos-header">
        <div>
          <h1>Edit Video</h1>
          <p>Update video information and workflow details.</p>
        </div>
