  ...
  useEffect(() => {
    const loadData = async () => {
      try {
        ...
        console.error("Load payment form data error:", error);
    ...
    <div className="payments-page">
      <div className="payments-header">
        <div>
          ...
          <p>Create and record a new client payment.</p>
        </div>
        <button type="button" className="payment-back-button" onClick={() => navigate("/payments")} disabled={saving}>
          Back
        </button>
      </div>
