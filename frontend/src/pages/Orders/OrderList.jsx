    ...
    <div className="orders-page">
      ...
      <div className="order-search-box">
        <input
          ...
          placeholder="Search orders by client, package or status..."
        />
      ...
      {loading ? (
        ...
        <div className="orders-empty">
          ...
          <p>
            Add your first order to start managing your
            orders.
          </p>
        </div>
        ...
        <div className="orders-empty">
          ...
          <p>
            No order matches your search. Try a different
            search term.
          </p>
        </div>
      ) : (
