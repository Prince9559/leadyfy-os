    ...
    <div className="creators-page">
      ...
      <div className="creator-search-box">
        <input
          ...
          placeholder="Search creators by name, email, category..."
        />

        <Search
          size={19}
          className="creator-search-icon"
        />
      </div>
      ...
      {loading ? (
        ...
        <div className="creators-empty">
          ...
          <p>
            Add your first creator to start
            managing your creator network.
          </p>
        </div>
        ...
        <div className="creators-empty">
          ...
          <p>
            No creator matches your search.
