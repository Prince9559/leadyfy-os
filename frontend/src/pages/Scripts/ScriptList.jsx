...
function ScriptList() {
  ...
  const filteredScripts = scripts.filter((script) => {
    ...
    const clientName =
      script.client?.companyName?.toLowerCase() || "";

    const orderName =
      script.order?.packageName?.toLowerCase() || "";
    ...
    <div className="scripts-page">
      ...
      <div className="script-search-box">
        <input
          ...
          placeholder="Search scripts by title, client or status..."
        />

        <Search
          size={19}
          className="script-search-icon"
        />
      </div>
      ...
      {loading ? (
        ...
        <div className="scripts-empty">
          ...
          <p>
            Add your first script to start managing your
            content.
          </p>
        </div>
        ...
        <div className="scripts-empty">
          ...
          <p>
            No script matches your search. Try a
          ...
          {filteredScripts.map((script) => (
            ...
            >
              ...
              <div className="script-card-actions">
                ...
                <button
                  type="button"
                  className="delete-script-button"
                  onClick={() =>
